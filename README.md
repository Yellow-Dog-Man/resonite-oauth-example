# Resonite OAuth Sample Express / Node.js

**This is purely meant as a technical example. It is not a complete app or ready for production use**

A quickly thrown together sample on how to use OAuth with Resonite.

## Status

Resonite's OAuth is still under construction.

## Setup

You will need OAuth Application credentials from the Resonite Team. **These aren't easy to get right now** and are given out manually to select applications or scenarios. You can request some by emailing [business@yellowdogman.com](mailto:business@yellowdogman.com).**Please don't spam them though. Only certain applications will be allowed right now.**
...
Once running, head to `localhost:8080/auth/authorize`. This will redirect you to Resonite' OAuth Systems, once you've logged in and accepted the application, you'll get redirected back to this webserver which will show your Resonite Profile Details.
